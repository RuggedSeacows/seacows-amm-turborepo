...
export default function Stepstitlen1hoveractive(props: IconProps) {
  ...
  return (
    ...
    >
      <g>
        <rect fill="url(#7b7f3__a)" rx="16" height="32" width="32" />
        <path
        ...
        />
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" y2="16" x2="32" y1="16" x1="0" id="7b7f3__a">
